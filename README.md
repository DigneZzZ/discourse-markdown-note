...
- ✅ **11 типов заметок:** `note`, `info`, `warn`, `negative`, `positive`, `caution`, `tip`, `todo`, `bug`, `feature`, `security`
- ✅ **Уникальные эмодзи иконки** для каждого типа заметок
- ✅ **Красивый дизайн** с градиентными фонами и современным стилем
- ✅ **Полная поддержка тем** с автоматическим определением светлой/темной темы
...
[tip]Это полезный совет[/tip]
[todo]Это задача к выполнению[/todo]
[bug]Это сообщение об ошибке[/bug]
[feature]Это новая функция[/feature]
[security]Это предупреждение безопасности[/security]
```
...
### 💡 Tip (Совет) - НОВЫЙ
Для полезных советов, подсказок и рекомендаций.

### 📝 Todo (Задача) - НОВЫЙ
Для списков задач, напоминаний и планов к выполнению.

### 🐛 Bug (Ошибка) - НОВЫЙ
Для сообщений об ошибках в коде, багрепортов и технических проблем.

### ✨ Feature (Новое) - НОВЫЙ
Для анонсов новых функций, обновлений и возможностей.

### 🔒 Security (Безопасность) - НОВЫЙ
Для предупреждений о безопасности, советов по защите данных.
