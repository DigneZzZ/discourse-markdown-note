...
- ✅ 9 типов заметок: `note`, `info`, `warn`, `negative`, `positive`, `caution`, `attention`, `security`, `tip`
...
[attention]Это заметка внимания[/attention]
...
### ⚡ Attention (Внимание)
Для важных заметок, требующих особого внимания пользователя.

### 🔒 Security (Безопасность)
Для заметок, связанных с безопасностью и конфиденциальностью.

### 🔥 Tip (Совет)
Для полезных советов и рекомендаций.
